...
public class LanceurMenuMulticolore {
	...
	public static void main(String[] args) {
		...
		items.add(new ElementMenu("Type Médicament", new Color(245, 124, 3), new Color(162, 198, 232), 100, ""));
		items.add(new ElementMenu("Stock", new Color(90, 37, 180), new Color(162, 198, 232), 100, "stock"));
		items.add(new ElementMenu("Commandes", new Color(194, 186, 18), new Color(162, 198, 232), 100, ""));
		...
		f.setSize(600, 600);
		f.add(new MenuCirculaire(Color.BLACK, 2*292, 2*266, 150, 100, items), BorderLayout.CENTER);
